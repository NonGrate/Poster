...
import com.example.poster.auth.AndroidAuthTokenStorage
...
actual fun platformModule(): Module = module {
    single<PlatformDataStore> { PlatformDataStoreImpl(androidContext()) }
    single<AuthTokenStorage> { AndroidAuthTokenStorage(androidContext()) }
    single<CrashStore> { FileCrashStore(androidContext()) }
}
