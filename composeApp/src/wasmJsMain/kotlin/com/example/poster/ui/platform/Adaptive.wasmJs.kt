// Web: the Android (Material 3) look, minus what only Android has — the same
// file as Adaptive.desktop.kt except the clock question, which asks the browser.
...
/** No system back gesture in the browser; screens offer their own back button. */
@Composable
...
@Composable
actual fun rememberUses24HourClock(): Boolean = browserUses24HourClock()

private fun browserUses24HourClock(): Boolean =
