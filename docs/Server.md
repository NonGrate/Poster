...
Where each value comes from, together with the client-side keys and GitHub
secrets: [`Credentials.md`](Credentials.md). Fill-in template: [`../server/.env.example`](../server/.env.example).
