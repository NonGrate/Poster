...
| Android | iOS | Web, wide |
|---|---|---|
| <img src="../screenshots/android/light-09b-post-comments.png" width="200"> | <img src="../screenshots/ios/light-09b-post-comments.png" width="200"> | <img src="../screenshots/web/light-06b-wide-comments.png" width="420"> |

The demo seed puts a three-comment conversation under the newest post and one
comment on another, so the count chip and the thread are in every capture.
