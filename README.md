...
| Groups | Invite-only groups: create, join by code or emailed invitation (single-use), owner and admins, member management, leave/close, deep links `poster://join/CODE`. |
